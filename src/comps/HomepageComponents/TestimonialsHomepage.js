      ...
      <div className="flex flex-col items-center md:flex-row md:justify-center gap-10">
        <div className="card w-full md:w-96 glass h-full bg-white">
          ...
          <div className="card-body">
            ...
            <p>
              ...
              and anxiety. In this time my sleep has improved greatly so much so
              , I am no longer clock watching until the early hours and I am
              waking up feeling far more refreshed. <br /> <br />I feel a lot
              calmer in general and my stress levels have reduced. Now .. the
              food cravings, considering I use to crave and graze, I am pleased
              to say that my mind set has improved.
              <br /> <br />
              My diet has improved greatly and I am learning to make healthy
              choices. <br /> <br />I will admit this nut has not been
              completely cracked yet, and I do have good and bad days still but
              its early days , that said I am pleased that I have lost 5lbs so
              far.
            </p>
          </div>
        </div>
        <div className="card w-full md:w-96 glass h-full bg-white">
          ...
          <div className="card-body">
            ...
            <p>
              I would thoroughly recommend this form of therapy.  I wouldn&#39;t
              believe it until I tried it myself. Hearing Dee’s calming  voice
              listening to the recording every night as I go off to sleep has
              had a real strong impact on my life.
              <br /> <br />
              Who knew the subconscious mind controlled so much of our
              Behaviours! I&#39;m feeling so much more in control and losing
              weight now with my changed relationship with food. In such a short
              space of time too! I still listen from time to time but I
              religiously played the recording every night for 21 days. 
              <br /> <br />
              Dee has a way about her that makes you feel at ease when you meet
              her. She is calm, caring and speaks softly I instantly have felt
              relaxed. I am recommending her to everyone I know who has any
              issue they are struggling with as I know this works!!!
            </p>
          </div>
        </div>
      </div>
