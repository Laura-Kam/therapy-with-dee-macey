  ...
  return (
    <Layout>
      <div
        ...
        <div className='hero-content text-center text-neutral-content'>
          <div className='max-w-md'>
            ...
            <p className='mb-5'>
              Hello there, my name is Dee.<br></br> Working together, we can use Rapid Transformational Therapy (RTT) to
              quickly identify and address the root cause of your psychological trauma. <br></br> Email me at:
              Dee@gmail.com. <br></br> I'm looking forward to working together.
            </p>
      ...
      <div style={{ textAlign: 'center', margin: '70px', padding: '40px' }}>
        <h1 style={{ fontWeight: 'bold', fontSize: '20px' }}>How can I help?</h1>
        <div className='stack'>
          <img
      ...
      <div>
        <div className='cardGridMargin grid grid-cols-3 gap-4 space-x-2.5 m-10'>
          <div
            ...
            <div className='card-body'>
              ...
              <p>
                RTT stands for Rapid Transformational Therapy. It was developed by the British therapist Marisa Peer,
                which combines NLP, hypnotherapy, psychotherapy, and CBT.
              </p>
          ...
          <div
            ...
            <div className='card-body'>
              ...
              <p>
                RTT is targetting towards overcoming anxiety disorder,low self-esteem, stress, depression, low
          ...
          <div
            ...
            <div className='card-body'>
              ...
              <p>
                The therapy generally involves a one-on-one session with a qualified RTT therapist.They lead client into
                a hypnotic state to access their subconscious mind and help them understand and alter their damaging
                beliefs and resulting behaviors.
              </p>
              <div className='card-actions'>
                <button className='btn btn-primary button-style'>Find Out More</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          <p>Video</p>
          <ReactPlayer url='https://vimeo.com/670217387' width='100%' height='100%' controls={true} playing={true} />
        </div>
      </div>
    </Layout>
  );
